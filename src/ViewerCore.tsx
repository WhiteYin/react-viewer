  ...
  function loadImg(currentActiveIndex, isReset = false, isOriginal = false) {
    ...
    img.onerror = () => {
      ...
      if (props.defaultImg) {
        ...
        const deafultImgWidth = props.defaultImg.width || containerSize.current.width * 0.5
