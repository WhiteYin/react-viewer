...
function ArrowRightIcon(): ReactElement {
  return (
    <svg className="wy-viewer-icon react-viewer-canvas-action" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3398" width="1em" height="1em" fill="currentColor">
      <path
